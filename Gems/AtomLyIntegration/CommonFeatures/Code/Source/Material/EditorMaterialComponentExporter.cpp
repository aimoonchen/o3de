    ...
    namespace Render
    {
        namespace EditorMaterialComponentExporter
        {
            ...
            bool OpenExportDialog(ExportItemsContainer& exportItems)
            {
                ...
                tableWidget->setColumnCount(static_cast<int>(headerLabels.size()));
                ...
                for (ExportItem& exportItem : exportItems)
                {
                    ...
                    QObject::connect(materialSlotCheckBox, &QCheckBox::checkStateChanged, materialSlotCheckBox, [&exportItem, materialFileWidget, materialSlotCheckBox, overwriteCheckBox]([[maybe_unused]] Qt::CheckState state) {
                    ...
                    QObject::connect(overwriteCheckBox, &QCheckBox::checkStateChanged, overwriteCheckBox, [&exportItem, overwriteCheckBox]([[maybe_unused]] Qt::CheckState state) {
