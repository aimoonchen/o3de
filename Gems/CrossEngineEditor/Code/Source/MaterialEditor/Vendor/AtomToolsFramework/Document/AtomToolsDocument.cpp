...
// Vendor copy of AtomToolsFramework Document for CrossEngineEditor.
// Original: Gems/Atom/Tools/AtomToolsFramework/Code/Source/Document/AtomToolsDocument.cpp
// Upstream commit: 5d81e5a48c
...
namespace AtomToolsFramework
{
    ...
    {
        // S1: Use the Core path resolver instead of Atom's ResolvePathReference.
        const auto sourcePath = ResolvePathReference(scanFolder, relativePath);
