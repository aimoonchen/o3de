...
// Vendor copy of AtomToolsFramework Document headers for CrossEngineEditor.
// Original: Gems/Atom/Tools/AtomToolsFramework/Code/Include/AtomToolsFramework/Document/
// Modifications: removed Atom RPI/RHI dependencies, added SourceDependencySet alias.

#include "AtomToolsDocumentRequestBus.h"
...
{
    //! Source dependency path sets for tracking related files.
    using SourceDependencySet = AZStd::unordered_set<AZ::IO::Path>;
    ...
    protected:
        ...
        SourceDependencySet m_sourceDependencies;
