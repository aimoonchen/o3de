...
// Vendor copy of AtomToolsFramework DynamicProperty headers for CrossEngineEditor.
// Original: Gems/Atom/Tools/AtomToolsFramework/Code/Include/AtomToolsFramework/DynamicProperty/
// Upstream commit: 329d3ec896
// Modifications: added S2/S5/S6 fields (colorSpace, fileExtensions, suffix).
...
{
    //! Color space used by color property editors.
    //! 0 = Linear (default, original Atom behavior)
    //! 1 = sRGB
    enum class PropertyColorSpace : AZ::u8
    {
        Linear = 0,
        Srgb = 1
    };
    ...
    struct DynamicPropertyConfig
    {
        ...
        AZ::u32 m_colorSpace = 0;

        // S5: File extension hints forwarded to the RPE asset picker
        AZStd::vector<AZStd::string> m_fileExtensions;

        // S6: Suffix string forwarded to the RPE (e.g. unit label)
