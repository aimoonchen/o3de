...
#include <MaterialEditor/Vendor/AtomToolsFramework/Inspector/InspectorRequestBus.h>
...
// Forward declare the Ui class (normally generated by AUTOUIC, but we inline the layout).
namespace Ui
{
...
namespace AtomToolsFramework
{
    ...
    protected:
        ...
        //! Override to provide a custom group header widget (e.g. with a checkbox).
        //! Default returns new InspectorGroupHeaderWidget.
        virtual InspectorGroupHeaderWidget* CreateGroupHeader(QWidget* parent);
    ...
    private:
        ...
        QWidget* m_headingContents = nullptr;
        QVBoxLayout* m_headingContentsLayout = nullptr;
        QScrollArea* m_groupScrollArea = nullptr;
        QWidget* m_groupContents = nullptr;
        QVBoxLayout* m_groupContentsLayout = nullptr;
