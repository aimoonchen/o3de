...
if(PAL_TRAIT_BUILD_HOST_TOOLS AND NOT O3DE_SCRIPT_ONLY)
    ...
    # Qt6 is a vendored 3rdParty package (industry-standard O3DE package flow),
    # resolved via find_package(Qt MODULE) which loads the package's FindQt.cmake
    # (qt-6.11.1-rev1-windows/FindQt.cmake). That script points find_package(Qt6)
    # at the SDK bundled inside the package and creates all 3rdParty::Qt::* alias
    # targets. This removes the previous dependency on a hard-coded local Qt6_DIR.
    #
    # ly_parse_third_party_dependencies triggers ly_download_associated_package
